...
const Links = () => {
  return (
    <div className="flex items-center flex-wrap justify-between my-3">
      <a href="">
        <span className="flex items-center space-x-1 px-2 py-1 mx-1 my-1 border rounded-lg">
          <svg
      ...
      <a href="">
        <span className="flex items-center space-x-1 px-2 py-1 border mx-1 my-1 rounded-lg">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="14"
            height="14"
